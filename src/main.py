...
while True:
    ...
    # ==== Open list ====
        ...
        list_id = get_valid_choice(input("Enter list ID to open: "), len(task_lists))
        if list_id is None:
        ...
        if action == 1:
            ...
            current_list.add_task(Task("New", name, description, priorities[priority]))
    ...
    # ==== Remove list ====
        ...
        choosen_id = get_valid_choice(input("Enter list ID to remove: "))
